...
public class CustomerStatementViewTest {
    ...
    private CustomerStatementView statementView;

    @Before
    public void setUp() throws Exception {
        regularMovie = new Movie(REGULAR_MOVIE_NAME, 0);
        customer = new Customer(CUSOMTER_NAME);
        statementView = new CustomerStatementView(customer);
    ...
    public void should_statement_for_regular_movie_and_rental_days_less_than_or_equal_to_2() {
        ...
        assertThat(statementView.generateStatement(), is(result(CUSOMTER_NAME, REGULAR_MOVIE_NAME, expectedTotalAmount, expectedFrequentRenterPoints)));
    }
    ...
    public void should_statement_for_new_release_movie_and_rental_days_less_than_or_equal_to_1() {
        ...
        int expectedFrequentRenterPoints = 1;
        assertThat(statementView.generateStatement(), is(result(CUSOMTER_NAME, NEW_RELEASE_MOVIE_NAME, expectedTotalAmount, expectedFrequentRenterPoints)));
    }
    ...
    public void should_statement_for_children_movie_and_rental_days_less_than_or_equal_to_3() {
        ...
        int expectedFrequentRenterPoints = 1;
        assertThat(statementView.generateStatement(), is(result(CUSOMTER_NAME, CHILDREN_MOVIE, expectedTotalAmount, expectedFrequentRenterPoints)));
    }
    ...
    public void should_statement_for_all_kinds_of_movie() {
        ...
        assertThat(statementView.generateStatement(), is("Rental Record for zhangyi\n\t" +
                "Brave Heart\t3.5\n" +
                "\tIron Man\t9.0\n" +
                "\tKongfu Panda\t1.5\n" +
                "Amount owed is 14.0\n" +
