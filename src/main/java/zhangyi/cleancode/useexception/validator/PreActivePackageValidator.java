package zhangyi.cleancode.useexception.validator;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import zhangyi.cleancode.useexception.entity.ActiveManifest;
import zhangyi.cleancode.useexception.entity.ActivePackageInfo;
import zhangyi.cleancode.useexception.entity.PackageStatusPackageSoft;
import zhangyi.cleancode.useexception.entity.PkgType;

import java.util.List;

import static zhangyi.cleancode.useexception.entity.RunStatus.PACKAGE_STATUS_OF_RUN;
    ...
    public long validatePreActivePkgStatus() {
        ...
        for (ActivePackageInfo pkg : activeManifest.getPkgInfos()) {
            ...
            for (PackageStatusPackageSoft pkgStatus : pkgStatusInfos) {
                ...
                if (pkg.getPkgType() == PkgType.BBU_SW_PATCH_PKG
                        || pkg.getPkgType() == PkgType.RRU_SW_PATCH_PKG
                        || pkg.getPkgType() == PkgType.PATCH_PKG) {
